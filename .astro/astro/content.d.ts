...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"blog": {
"awning-stay-repair-storm.md": {
	id: "awning-stay-repair-storm.md";
  slug: "awning-stay-repair-storm";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"christmas-closure-2025.md": {
	id: "christmas-closure-2025.md";
  slug: "christmas-closure-2025";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
