...
- **Leak/mitre reseal**: If water tracks under the sill, we may need a [mitre & sill reseal](/services/mitre-reseal/) to back-seal the frame correctly.

## When costs climb

- **Corroded or obsolete hardware** that must be sourced or substituted.
- **Damaged tracks beyond resurfacing** that need full replacement.
- **Water ingress from poor sealing** that requires in-frame reseal, not just rollers.
...
We service Wellington, Porirua, Lower Hutt, Upper Hutt, Petone and Kāpiti. Same-week bookings where possible.

- Book a quote: [Contact form](/contact/) or call **021 638 205**
- Learn more: [Sliding/ranchslider door repairs](/services/sliding-door-repairs/)
- If there’s moisture at corners/sill: [Mitre & sill reseal](/services/mitre-reseal/)
