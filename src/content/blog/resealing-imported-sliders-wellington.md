...
## The New Zealand context (what “good” looks like)
...
This is remedial work within the aluminium joinery, not a perimeter install into the wall.

1. Strip & prep: remove failed sealants, clean to sound aluminium, abrade oxidation, solvent‑wipe and dry.
2. Reinstate the internal primary/joint seal (the fabrication “air/joint” line used inside aluminium frames) using a neutral‑cure, aluminium‑safe sealant suitable for narrow joints.
3. Apply the external weather seal (the over/backing seal used in manufacture) and tool for water‑shedding. Keep all weep/drain paths open.
4. QA: gentle hose test (no high‑pressure), confirm drainage and photo‑record before/after.
...
## Need help in Wellington?

We reseal leaking aluminium sliders across Wellington, Hutt, Porirua and Kāpiti.
...
Internal links: see our pages on <a href="/leaks/">draughts & leaks</a> and <a href="/services/sliding-door-repairs/">sliding/ranchslider repairs</a> for more detail.
